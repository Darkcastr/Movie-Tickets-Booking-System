...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <?php if(Session::has('user_id')): ?>
        <form method="POST" action="/logout" class="ms-auto"><?php echo e(csrf_field()); ?><button type="submit" class="btn btn-link text-light"><i class="bi bi-box-arrow-right"></i> Logout</button></form>
    <?php else: ?>
        <div class="ms-auto">
...
<?php /**PATH C:\laragon\www\movie-booking\resources\views/layouts/app.blade.php ENDPATH**/ ?>